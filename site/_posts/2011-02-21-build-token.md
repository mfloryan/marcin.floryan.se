...
[![](/assets/images/2011/02/release-cow-150x150.jpg "118-1884\_IMG-Release-cow")](https://www.flickr.com/photos/42514466@N08/5407848023/)
{% endfigure %}

When software development teams start with the practice of [Continuous Integration](https://martinfowler.com/articles/continuousIntegration.html) (CI) coordinating check-ins and keeping the build clean can be a challenge. Some habits like making sure all unit tests pass locally, project builds correctly, and all relevant files are included, are not yet established. Introducing a simple _build token_ is often helpful. This is how [Rachel](https://agilecoach.typepad.com/about.html) and [Liz](https://www.agilecoach.co.uk/) describe it in their "[Agile Coaching](https://www.pragprog.com/titles/sdcoach/agile-coaching)" book:
...
[![](/assets/images/2011/02/5050724001_009d4ebd00_m.jpg "5050724001\_009d4ebd00\_m")](https://www.flickr.com/photos/agileinaction/5050724001)
{% endfigure %}

Mature and experienced teams usually no longer need to use a token yet they often choose to keep it or adopt its use. At [Energized Work](https://www.enegizedwork.com/), for example, we use a _broken build token_. If a pair breaks the build, they pick from a selection of [fancy hats](https://www.flickr.com/photos/agileinaction/2870360908/) to let the team know who is currently working to fix the problem. It is important as a broken build can impede others' progress. (It is also in line with the _stop the line_ Lean approach.)
