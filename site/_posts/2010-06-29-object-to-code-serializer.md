...
You can download it from CodePlex [https://objectserialiser.codeplex.com/](https://objectserialiser.codeplex.com/)
...
Is anything better out there? Ideally, this could now be hooked into Visual Studio somehow to make the job even easier. Unfortunately [Code Visualisers](https://msdn.microsoft.com/en-us/library/zayyhzts.aspx) won't do the job as they can't be registered for "object".
