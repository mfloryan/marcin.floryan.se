...
**TL;DR;** If you’re ever tempted to write your own date handling – don’t. Unless you’re [Jon Skeet](http://stackoverflow.com/users/22656/jon-skeet) you’re usually better off using existing libraries like [JodaTime](http://joda-time.sourceforge.net/) or [NodaTime](http://code.google.com/p/noda-time/)
...
It’s probably a slightly better solution. That is until we discover there is this thing called a [leap second](http://en.wikipedia.org/wiki/Leap_second).

So next time I’m tempted to write any date handling code in JavaScript I’ll first turn to StackOverflow and see if there’s already [something out there](http://stackoverflow.com/questions/802861/javascript-date-manipulation-library).
