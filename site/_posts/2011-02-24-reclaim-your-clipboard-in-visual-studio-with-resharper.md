...
I have been doing quite a bit of grails development recently and used [IntelliJ IDEA](https://www.jetbrains.com/idea/) IDE. In many respects it is a very good environment (as good as IDEs can be), for me more friendly and usable than NetBeans or Eclipse.

One of the features I really like is the [clipboard stacking](https://www.jetbrains.com/idea/features/essential_editing_features.html#Clipboard_stacking) which allows you to paste from your clipboard copy history.
...
Fortunately I have [ReSharper](https://www.jetbrains.com/resharper/) installed (I struggle to do any work without it in Visual Studio anyway) and it has the very same feature as IntelliJ - look in the menu under _ReSharper \> Edit \> Paste_.
